...
//                   TextFormat(
//                     text: StateParameters.getBodyText(currentInputValue, _unit),
//                     context: context,
//                     type: "titleSmall",
//                   ),
//                   StateParameters.getBodyText(currentInputValue, _unit) !=
//                               "Óptimo" &&
//                           StateParameters.getBodyText(
//                                 currentInputValue,
//                                 _unit,
//                               ) !=
//                               "Ideal" &&
...
//             TextFormat(
//               text: _unit != "NTU"
//                   ? "${context.l10n.detalles_rango_permitido} ${_rangeMin != null ? "$_rangeMin $_unit" : ""} - ${_rangeMax != null ? "$_rangeMax $_unit" : ""}"
//                   : "${context.l10n.detalles_rango_permitido} ${_rangeMax != null ? "$_rangeMax $_unit" : ""}",
//               context: context,
//               type: "body",
//             ),
//           ],
...
//                 onConfirm: () => DialogExportCsv.show(
//                   context: context,
//                   depositData: widget.depositData,
//                 ),
//                 isLoading: readingProvider.isLoading,
//               ),
//             ),
//             AppSizedBox.width8,
//             Expanded(
